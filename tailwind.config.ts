  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        body: ['Nunito', 'Comfortaa', 'sans-serif'],
      },
      colors: {
        ...
        "chat-attendant": "hsl(var(--chat-attendant))",
        "chat-attendant-foreground": "hsl(var(--chat-attendant-foreground))",
        "chat-attendant-border": "hsl(var(--chat-attendant-border))",
        "chat-system": "hsl(var(--chat-system))",
        "chat-system-foreground": "hsl(var(--chat-system-foreground))",
        "chat-system-border": "hsl(var(--chat-system-border))",
        ...
        chart: {
          ...
          wisteria: "hsl(var(--chart-wisteria))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
